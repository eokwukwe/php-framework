...
use EOkwukwe\Framework\Container\Container;
use EOkwukwe\Framework\Container\ContainerException;
...
class ContainerTest extends TestCase
{
    ...
    public function a_service_can_be_retrieved_from_the_container()
    {
        ...
        // Do something. id string, concrete class name string | object
        $container->add('dependant-class', DependantClass::class);

        // Make assertions
        $this->assertInstanceOf(
            DependantClass::class,
    ...
    public function services_can_be_recursively_autowired()
    {
        ...
        $this->assertInstanceOf(
            SubDependencyClass::class,
            $dependancyService->getSubDependency()
        );
    }
}
